...
Notation: 
- $\newcommand{\half}[0]{\left\lceil\frac{n}{2}\right\rceil}\half _1 = \half$
- $\newcommand{\half}[0]{\left\lceil\frac{n}{2}\right\rceil}\half _1 = \half$ 
- $\newcommand{\half}[0]{\left\lceil\frac{n}{2}\right\rceil}\half _{k+1} = \left \lceil \half_k/2 \right \rceil$ 
- $N:$ power of $2$ s.t. <br>
$n \leq N < 2n$
...
Complexity: $\newcommand{\half}[0]{\left\lceil\frac{n}{2}\right\rceil}C(n) \leq 3C(\half) + \lambda n$ coefficient operations
